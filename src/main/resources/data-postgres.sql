...
insert into errand (id, creation_time, deadline, pharmacy_id) values (10, '2021-02-06 10:38:09.147', '2021-03-05 01:00:00', 2);
insert into errand (id, creation_time, deadline, pharmacy_id) values (11, '2021-02-06 10:38:09.147', '2021-03-05 01:00:00', 2);

insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (1, 5, 10, 2);
insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (2, 7, 10, 5);
insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (3, 3, 10, 7);

insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (4, 5, 11, 2);
insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (5, 7, 11, 5);
insert into medicine_quantity (id, quantity, errand_id, medicine_id) values (6, 3, 11, 7);

insert into offer (id, price, supply_deadline, errand_id, supplier_id) values (10, 10000, '2021-04-05 01:00:00', 10, 25);
insert into offer (id, price, supply_deadline, errand_id, supplier_id) values (11, 12000, '2021-03-25 01:00:00', 10, 26);

insert into offer (id, price, supply_deadline, errand_id, supplier_id) values (12, 10000, '2021-04-05 01:00:00', 11, 25);
insert into offer (id, price, supply_deadline, errand_id, supplier_id) values (13, 12000, '2021-03-25 01:00:00', 11, 26);